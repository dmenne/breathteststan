...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(84, 82, "end", "model_breath_test_group_1");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            size_t pat_i_k_0_max__ = n;
            for (size_t k_0__ = 0; k_0__ < pat_i_k_0_max__; ++k_0__) {
                pat_i[k_0__] = vals_i__[pos__++];
            }
            size_t pat_i_i_0_max__ = n;
            for (size_t i_0__ = 0; i_0__ < pat_i_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "pat_i[i_0__]", pat_i[i_0__], 0);
            }
            ...
            pos__ = 0;
            size_t group_i_k_0_max__ = n;
            for (size_t k_0__ = 0; k_0__ < group_i_k_0_max__; ++k_0__) {
                group_i[k_0__] = vals_i__[pos__++];
            }
            size_t group_i_i_0_max__ = n;
            for (size_t i_0__ = 0; i_0__ < group_i_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "group_i[i_0__]", group_i[i_0__], 0);
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("m_pat_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable m_pat_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("m_pat_raw");
        pos__ = 0U;
        validate_non_negative_index("m_pat_raw", "n_pat", n_pat);
        context__.validate_dims("parameter initialization", "m_pat_raw", "vector_d", context__.to_vec(n_pat));
        Eigen::Matrix<double, Eigen::Dynamic, 1> m_pat_raw(n_pat);
        size_t m_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < m_pat_raw_j_1_max__; ++j_1__) {
            m_pat_raw(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(m_pat_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable m_pat_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 18;
        if (!(context__.contains_r("m_group")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable m_group missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("m_group");
        pos__ = 0U;
        validate_non_negative_index("m_group", "n_group", n_group);
        context__.validate_dims("parameter initialization", "m_group", "vector_d", context__.to_vec(n_group));
        Eigen::Matrix<double, Eigen::Dynamic, 1> m_group(n_group);
        size_t m_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < m_group_j_1_max__; ++j_1__) {
            m_group(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(m_group);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable m_group: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 19;
        if (!(context__.contains_r("sigma_m_pat")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_m_pat missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_m_pat");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_m_pat", "double", context__.to_vec());
        double sigma_m_pat(0);
        sigma_m_pat = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_m_pat);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_m_pat: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 20;
        ...
        if (!(context__.contains_r("k_pat_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable k_pat_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("k_pat_raw");
        pos__ = 0U;
        validate_non_negative_index("k_pat_raw", "n_pat", n_pat);
        context__.validate_dims("parameter initialization", "k_pat_raw", "vector_d", context__.to_vec(n_pat));
        Eigen::Matrix<double, Eigen::Dynamic, 1> k_pat_raw(n_pat);
        size_t k_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < k_pat_raw_j_1_max__; ++j_1__) {
            k_pat_raw(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(k_pat_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable k_pat_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 23;
        if (!(context__.contains_r("k_group")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable k_group missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("k_group");
        pos__ = 0U;
        validate_non_negative_index("k_group", "n_group", n_group);
        context__.validate_dims("parameter initialization", "k_group", "vector_d", context__.to_vec(n_group));
        Eigen::Matrix<double, Eigen::Dynamic, 1> k_group(n_group);
        size_t k_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < k_group_j_1_max__; ++j_1__) {
            k_group(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(k_group);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable k_group: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 24;
        if (!(context__.contains_r("sigma_k_pat")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_k_pat missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_k_pat");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_k_pat", "double", context__.to_vec());
        double sigma_k_pat(0);
        sigma_k_pat = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_k_pat);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_k_pat: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 25;
        ...
        if (!(context__.contains_r("beta_pat_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_pat_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_pat_raw");
        pos__ = 0U;
        validate_non_negative_index("beta_pat_raw", "n_pat", n_pat);
        context__.validate_dims("parameter initialization", "beta_pat_raw", "vector_d", context__.to_vec(n_pat));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_pat_raw(n_pat);
        size_t beta_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < beta_pat_raw_j_1_max__; ++j_1__) {
            beta_pat_raw(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(beta_pat_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_pat_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 28;
        if (!(context__.contains_r("beta_group")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_group missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_group");
        pos__ = 0U;
        validate_non_negative_index("beta_group", "n_group", n_group);
        context__.validate_dims("parameter initialization", "beta_group", "vector_d", context__.to_vec(n_group));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_group(n_group);
        size_t beta_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < beta_group_j_1_max__; ++j_1__) {
            beta_group(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(beta_group);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_group: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 29;
        if (!(context__.contains_r("sigma_beta_pat")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_beta_pat missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_beta_pat");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_beta_pat", "double", context__.to_vec());
        double sigma_beta_pat(0);
        sigma_beta_pat = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_beta_pat);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_beta_pat: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 30;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            // model parameters
            current_statement_begin__ = 17;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> m_pat_raw;
            ...
            current_statement_begin__ = 18;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> m_group;
            ...
            current_statement_begin__ = 22;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> k_pat_raw;
            ...
            current_statement_begin__ = 23;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> k_group;
            ...
            current_statement_begin__ = 27;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_pat_raw;
            ...
            current_statement_begin__ = 28;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_group;
            ...
            current_statement_begin__ = 29;
            local_scalar_t__ sigma_beta_pat;
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_pat(n_pat);
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 36;
            size_t pdr1_j_1_max__ = n;
            for (size_t j_1__ = 0; j_1__ < pdr1_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(pdr1(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: pdr1" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable pdr1: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 37;
            size_t m_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < m_pat_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(m_pat(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: m_pat" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable m_pat: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 38;
            size_t k_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < k_pat_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(k_pat(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: k_pat" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable k_pat: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 39;
            size_t beta_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < beta_pat_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(beta_pat(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: beta_pat" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable beta_pat: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 40;
            if (stan::math::is_uninitialized(mn)) {
                ...
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mn: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            ...
            if (stan::math::is_uninitialized(kn)) {
                ...
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable kn: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            ...
            if (stan::math::is_uninitialized(betan)) {
                ...
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable betan: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            ...
            lp_accum__.add(normal_log<propto__>(k_group, 0, 0.005));
            current_statement_begin__ = 69;
            lp_accum__.add(normal_log<propto__>(mu_k, 0.007, 0.002));
            ...
            lp_accum__.add(normal_log<propto__>(mu_beta, 2, 0.4));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> m_pat_raw = in__.vector_constrain(n_pat);
        size_t m_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < m_pat_raw_j_1_max__; ++j_1__) {
            vars__.push_back(m_pat_raw(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> m_group = in__.vector_constrain(n_group);
        size_t m_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < m_group_j_1_max__; ++j_1__) {
            vars__.push_back(m_group(j_1__));
        }
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> k_pat_raw = in__.vector_constrain(n_pat);
        size_t k_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < k_pat_raw_j_1_max__; ++j_1__) {
            vars__.push_back(k_pat_raw(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> k_group = in__.vector_constrain(n_group);
        size_t k_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < k_group_j_1_max__; ++j_1__) {
            vars__.push_back(k_group(j_1__));
        }
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_pat_raw = in__.vector_constrain(n_pat);
        size_t beta_pat_raw_j_1_max__ = n_pat;
        for (size_t j_1__ = 0; j_1__ < beta_pat_raw_j_1_max__; ++j_1__) {
            vars__.push_back(beta_pat_raw(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_group = in__.vector_constrain(n_group);
        size_t beta_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < beta_group_j_1_max__; ++j_1__) {
            vars__.push_back(beta_group(j_1__));
        }
        ...
        try {
            ...
            current_statement_begin__ = 36;
            validate_non_negative_index("pdr1", "n", n);
            Eigen::Matrix<double, Eigen::Dynamic, 1> pdr1(n);
            stan::math::initialize(pdr1, DUMMY_VAR__);
            stan::math::fill(pdr1, DUMMY_VAR__);
            current_statement_begin__ = 37;
            validate_non_negative_index("m_pat", "n_pat", n_pat);
            Eigen::Matrix<double, Eigen::Dynamic, 1> m_pat(n_pat);
            stan::math::initialize(m_pat, DUMMY_VAR__);
            stan::math::fill(m_pat, DUMMY_VAR__);
            current_statement_begin__ = 38;
            validate_non_negative_index("k_pat", "n_pat", n_pat);
            Eigen::Matrix<double, Eigen::Dynamic, 1> k_pat(n_pat);
            stan::math::initialize(k_pat, DUMMY_VAR__);
            stan::math::fill(k_pat, DUMMY_VAR__);
            current_statement_begin__ = 39;
            validate_non_negative_index("beta_pat", "n_pat", n_pat);
            Eigen::Matrix<double, Eigen::Dynamic, 1> beta_pat(n_pat);
            stan::math::initialize(beta_pat, DUMMY_VAR__);
            stan::math::fill(beta_pat, DUMMY_VAR__);
            current_statement_begin__ = 40;
            double mn;
            ...
            if (include_tparams__) {
                size_t pdr1_j_1_max__ = n;
                for (size_t j_1__ = 0; j_1__ < pdr1_j_1_max__; ++j_1__) {
                    vars__.push_back(pdr1(j_1__));
                }
                size_t m_pat_j_1_max__ = n_pat;
                for (size_t j_1__ = 0; j_1__ < m_pat_j_1_max__; ++j_1__) {
                    vars__.push_back(m_pat(j_1__));
                }
                size_t k_pat_j_1_max__ = n_pat;
                for (size_t j_1__ = 0; j_1__ < k_pat_j_1_max__; ++j_1__) {
                    vars__.push_back(k_pat(j_1__));
                }
                size_t beta_pat_j_1_max__ = n_pat;
                for (size_t j_1__ = 0; j_1__ < beta_pat_j_1_max__; ++j_1__) {
                    vars__.push_back(beta_pat(j_1__));
                }
                vars__.push_back(mn);
                vars__.push_back(kn);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < m_pat_raw_j_1_max__; ++j_1__) {
            ...
            param_name_stream__ << "m_pat_raw" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t m_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < m_group_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "m_group" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        for (size_t j_1__ = 0; j_1__ < k_pat_raw_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "k_pat_raw" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t k_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < k_group_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "k_group" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        for (size_t j_1__ = 0; j_1__ < beta_pat_raw_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "beta_pat_raw" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t beta_group_j_1_max__ = n_group;
        for (size_t j_1__ = 0; j_1__ < beta_group_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "beta_group" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < pdr1_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "pdr1" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t m_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < m_pat_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "m_pat" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t k_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < k_pat_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "k_pat" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t beta_pat_j_1_max__ = n_pat;
            for (size_t j_1__ = 0; j_1__ < beta_pat_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "beta_pat" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            param_name_stream__.str(std::string());
...
typedef model_breath_test_group_1_namespace::model_breath_test_group_1 stan_model;
#endif
