...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        check_greater_or_equal(function__,"student_df",student_df,1);
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(cauchy_log<propto__>(sigma, 0, 5));
            {
                ...
                if (as_bool(logical_lte(student_df,10))) {
                    current_statement_begin__ = 72;
                    lp_accum__.add(student_t_log<propto__>(pdr, student_df, pdr1, sigma));
                } else {
